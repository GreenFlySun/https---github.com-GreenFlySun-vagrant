...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "nginx1" do |nginx1|
    ...
    nginx1.vm.network "private_network", ip: "192.168.1.1"
  ...
  config.vm.define "nginx2" do |nginx2|
    ...
    nginx2.vm.network "private_network", ip: "192.168.2.1"
  ...
  config.vm.define "nginx_proxy" do |nginx_proxy|
    ...
    nginx_proxy.vm.network "private_network", ip: "192.168.1.2"
    nginx_proxy.vm.network "private_network", ip: "192.168.2.2"
